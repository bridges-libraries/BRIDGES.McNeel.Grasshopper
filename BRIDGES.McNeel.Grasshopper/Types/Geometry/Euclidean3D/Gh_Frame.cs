...
namespace BRIDGES.McNeel.Grasshopper.Types.Geometry.Euclidean3D
{
    ...
    public class Gh_Frame : GH_Types.GH_Goo<Euc3D.Frame>, GH_Kernel.IGH_PreviewData
    {
        ...
        /// </summary>
        /// <param name="frame"> <see cref="Euc3D.Frame"/> for the grasshopper type.</param>
        ...
        public override bool CastFrom(object source)
        {
            ...
            // Casts a Gh_Frame to a Gh_Frame
            if (typeof(Gh_Frame).IsAssignableFrom(type))
            {
                Euc3D.Frame frame = ((Gh_Frame)source).Value;
        ...
        public override bool CastTo<T>(ref T target)
        {
            ...
            // Casts a Gh_Frame to a Gh_Frame
            if (typeof(T).IsAssignableFrom(typeof(Gh_Frame)))
            {
