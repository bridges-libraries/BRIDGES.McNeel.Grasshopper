...
{
    /// <summary>
    /// A <see cref="Gh_Plane"/> grasshopper parameter.
    /// </summary>
    public class Param_Plane : GH_Kernel.GH_Param<Gh_Plane>, GH_Kernel.IGH_PreviewObject
    {
        #region Properties
        ...
        /// </summary>
        public Param_Plane()
          : base("Plane", "Plane", "Contains a collection of planes in a three-dimensional euclidean space.", "BRIDGES.McNeel.Grasshopper", "Parameters", GH_Kernel.GH_ParamAccess.item)
        {
            this.Hidden = false;
        }
        ...
        public Param_Plane(string category, string subCategory)
          : base("Plane", "Plane", "Contains a collection of planes in a three-dimensional euclidean space.", category, subCategory, GH_Kernel.GH_ParamAccess.item)
        {
            this.Hidden = false;
        }
        ...
        public void DrawViewportWires(GH_Kernel.IGH_PreviewArgs args)
        {
            ...
            if (dataCount != 0)
            {
                ...
                {
                    List<Gh_Plane> branch = m_data.Branches[i_B];
                    for (int i_I = 0; i_I < branch.Count; i_I++)
                    {
                        var item = branch[i_I];
                        if (item != null)
                        {
                            Draw.Wireframe.Plane(args.Display, item.Value, isSelected);
                        }
                    }
                }
            }
        ...
        {
            get { return new Guid("{BA0CEDFC-4DE6-4618-8C2C-0FDF99B3CE6C}"); }
        }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                System.IO.Stream stream = assembly.GetManifestResourceStream("BRIDGES.McNeel.Grasshopper.Resources.Geometry.Euclidean3D." + "Param_Plane.png");
