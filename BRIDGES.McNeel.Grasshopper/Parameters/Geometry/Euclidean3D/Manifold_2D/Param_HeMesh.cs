...
namespace BRIDGES.McNeel.Grasshopper.Parameters.Geometry.Euclidean3D
{
    ...
    public class Param_HeMesh : GH_Kernel.GH_Param<Gh_HeMesh>, GH_Kernel.IGH_PreviewObject
    {
        ...
        /// </summary>
        public Param_HeMesh()
          : base("Halfedge Mesh", "HeMesh", "Contains a collection of halfedge meshes in a three-dimensional euclidean space.", "BRIDGES Basics", "Parameters", GH_Kernel.GH_ParamAccess.item)
        {
            this.Hidden = false;
        }
