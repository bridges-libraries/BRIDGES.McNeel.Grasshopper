...
{
    /// <summary>
    /// A <see cref="Gh_HeMesh"/> grasshopper parameter.
    /// </summary>
    public class Param_HeMesh : GH_Kernel.GH_Param<Gh_HeMesh>, GH_Kernel.IGH_PreviewObject
    {
        #region Properties
        ...
        /// </summary>
        public Param_HeMesh()
          : base("Halfedge Mesh", "HeMesh", "Contains a collection of halfedge meshes in a three-dimensional euclidean space.", "BRIDGES.McNeel.Grasshopper", "Parameters", GH_Kernel.GH_ParamAccess.item)
        {
            this.Hidden = false;
        }
        ...
        public void DrawViewportWires(GH_Kernel.IGH_PreviewArgs args)
        {
            ...
            if (dataCount != 0)
            {
                ...
                {
                    List<Gh_HeMesh> branch = m_data.Branches[i_B];
                    for (int i_I = 0; i_I < branch.Count; i_I++)
                    {
                        var item = branch[i_I];
                        if (item != null)
                        {
                            Draw.Wireframe.Mesh(args.Display, item.Value, isSelected);
                        }
                    }
                }
            }
        ...
        {
            get { return new Guid("{08EFA156-0F3C-47DF-A292-53450721CD9C}"); }
        }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                System.IO.Stream stream = assembly.GetManifestResourceStream("BRIDGES.McNeel.Grasshopper.Resources.Geometry.Euclidean3D." + "Param_HeMesh.png");
