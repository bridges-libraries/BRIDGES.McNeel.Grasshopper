...
namespace BRIDGES.McNeel.Grasshopper.Parameters.Geometry.Euclidean3D
{
    ...
    public class Param_Sphere : GH_Kernel.GH_Param<Gh_Sphere>, GH_Kernel.IGH_PreviewObject
    {
        ...
        /// </summary>
        public Param_Sphere()
          : base("Sphere", "Sphere", "Contains a collection of spheres in a three-dimensional euclidean space.", "BRIDGES.McNeel.Grasshopper", "Parameters", GH_Kernel.GH_ParamAccess.item)
        {
            this.Hidden = false;
        }
