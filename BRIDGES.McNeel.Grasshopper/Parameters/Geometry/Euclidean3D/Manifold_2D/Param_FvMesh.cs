...
namespace BRIDGES.McNeel.Grasshopper.Parameters.Geometry.Euclidean3D
{
    ...
    public class Param_FvMesh : GH_Kernel.GH_Param<Gh_FvMesh>, GH_Kernel.IGH_PreviewObject
    {
        ...
        /// </summary>
        public Param_FvMesh()
          : base("Face-Vertex Mesh", "FvMesh", "Contains a collection of face-vertex meshes in a three-dimensional euclidean space.", "BRIDGES.McNeel.Grasshopper", "Parameters", GH_Kernel.GH_ParamAccess.item)
        {
            this.Hidden = false;
        }
