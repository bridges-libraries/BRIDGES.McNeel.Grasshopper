...
{
    /// <summary>
    /// A <see cref="Gh_Segment"/> grasshopper parameter.
    /// </summary>
    public class Param_Segment : GH_Kernel.GH_Param<Gh_Segment>, GH_Kernel.IGH_PreviewObject
    {
        #region Properties
        ...
        public Param_Segment()
          : base("Segment", "Segment", "Contains a collection of segments in a three-dimensional euclidean space.", "BRIDGES.McNeel.Grasshopper", "Parameters", GH_Kernel.GH_ParamAccess.item)
        {
            this.Hidden = false;
        }
        ...
        public Param_Segment(string category, string subCategory)
          : base("Segment", "Segment", "Contains a collection of segments in a three-dimensional euclidean space.", category, subCategory, GH_Kernel.GH_ParamAccess.item)
        {
            this.Hidden = false;
        }
        ...
        public void DrawViewportWires(GH_Kernel.IGH_PreviewArgs args)
        {
            ...
            if (dataCount != 0)
            {
                ...
                {
                    List<Gh_Segment> branch = m_data.Branches[i_B];
        ...
        {
            get { return new Guid("{63F42F38-B8ED-4200-B221-BB51685BD348}"); }
        }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                System.IO.Stream stream = assembly.GetManifestResourceStream("BRIDGES.McNeel.Grasshopper.Resources.Geometry.Euclidean3D." + "Param_Segment.png");
