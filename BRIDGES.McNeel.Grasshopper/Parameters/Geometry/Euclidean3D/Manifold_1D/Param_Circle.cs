...
{
    /// <summary>
    /// A <see cref="Gh_Circle"/> grasshopper parameter.
    /// </summary>
    public class Param_Circle : GH_Kernel.GH_Param<Gh_Circle>, GH_Kernel.IGH_PreviewObject
    {
        #region Properties
        ...
        /// </summary>
        public Param_Circle()
          : base("Circle", "Circle", "Contains a collection of circles in a three-dimensional euclidean space.", "BRIDGES.McNeel.Grasshopper", "Parameters", GH_Kernel.GH_ParamAccess.item)
        {
            this.Hidden = false;
        }
        ...
        public Param_Circle(string category, string subCategory)
          : base("Circle", "Circle", "Contains a collection of circles in a three-dimensional euclidean space.", category, subCategory, GH_Kernel.GH_ParamAccess.item)
        {
            this.Hidden = false;
        }
        ...
        public void DrawViewportWires(GH_Kernel.IGH_PreviewArgs args)
        {
            ...
            if (dataCount != 0)
            {
                ...
                {
                    List<Gh_Circle> branch = m_data.Branches[i_B];
                    for (int i_I = 0; i_I < branch.Count; i_I++)
                    {
                        var item = branch[i_I];
                        if (item != null)
                        {
                            Draw.Wireframe.Circle(args.Display, item.Value, isSelected);
                        }
                    }
                }
            }
        ...
        {
            get { return new Guid("{A8DDF8CD-EAE7-42E7-BC43-31DA7B42C4D1}"); }
        }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                System.IO.Stream stream = assembly.GetManifestResourceStream("BRIDGES.McNeel.Grasshopper.Resources.Geometry.Euclidean3D." + "Param_Circle.png");
