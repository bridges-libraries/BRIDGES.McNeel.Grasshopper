...
{
    /// <summary>
    /// A <see cref="Gh_Ray"/> grasshopper parameter.
    /// </summary>
    public class Param_Ray : GH_Kernel.GH_Param<Gh_Ray>, GH_Kernel.IGH_PreviewObject
    {
        #region Properties
        ...
        /// </summary>
        public Param_Ray()
          : base("Ray", "Ray", "Contains a collection of rays in a three-dimensional euclidean space.", "BRIDGES.McNeel.Grasshopper", "Parameters", GH_Kernel.GH_ParamAccess.item)
        {
            this.Hidden = false;
        }
        ...
        public Param_Ray(string category, string subCategory)
          : base("Ray", "Ray", "Contains a collection of rays in a three-dimensional euclidean space.", category, subCategory, GH_Kernel.GH_ParamAccess.item)
        {
            this.Hidden = false;
        }
        ...
        public void DrawViewportWires(GH_Kernel.IGH_PreviewArgs args)
        {
            ...
            if (dataCount != 0)
            {
                ...
                {
                    List<Gh_Ray> branch = m_data.Branches[i_B];
                    for (int i_I = 0; i_I < branch.Count; i_I++)
                    {
                        var item = branch[i_I];
                        if (item != null)
                        {
                            Draw.Wireframe.Ray(args.Display, item.Value, isSelected);
                        }
                    }
                }
            }
        ...
        {
            get { return new Guid("{59708623-69F4-426B-9E38-CDD768C511A1}"); }
        }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                System.IO.Stream stream = assembly.GetManifestResourceStream("BRIDGES.McNeel.Grasshopper.Resources.Geometry.Euclidean3D." + "Param_Ray.png");
