...
{
    /// <summary>
    /// A <see cref="Gh_Line"/> grasshopper parameter.
    /// </summary>
    public class Param_Line: GH_Kernel.GH_Param<Gh_Line>, GH_Kernel.IGH_PreviewObject
    {
        #region Properties
        ...
        /// </summary>
        public Param_Line()
          : base("Line", "Line", "Contains a collection of lines in a three-dimensional euclidean space.", "BRIDGES.McNeel.Grasshopper", "Parameters", GH_Kernel.GH_ParamAccess.item)
        {
            this.Hidden = false;
        }
        ...
        public Param_Line(string category, string subCategory)
          : base("Line", "Line", "Contains a collection of lines in a three-dimensional euclidean space.", category, subCategory, GH_Kernel.GH_ParamAccess.item)
        {
            this.Hidden = false;
        }
        ...
        public void DrawViewportWires(GH_Kernel.IGH_PreviewArgs args)
        {
            ...
            if (dataCount != 0)
            {
                ...
                {
                    List<Gh_Line> branch = m_data.Branches[i_B];
        ...
        {
            get { return new Guid("{9FC7A197-5FCD-4C3D-851D-118A10947973}"); }
        }
