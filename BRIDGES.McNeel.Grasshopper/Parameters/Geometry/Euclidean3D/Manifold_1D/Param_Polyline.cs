...
namespace BRIDGES.McNeel.Grasshopper.Parameters.Geometry.Euclidean3D
{
    ...
    public class Param_Polyline : GH_Kernel.GH_Param<Gh_Polyline>, GH_Kernel.IGH_PreviewObject
    {
        ...
        public Param_Polyline()
          : base("Polyline", "Polyline", "Contains a collection of polylines in a three-dimensional euclidean space.", "BRIDGES.McNeel.Grasshopper", "Parameters", GH_Kernel.GH_ParamAccess.item)
        {
            this.Hidden = false;
        }
